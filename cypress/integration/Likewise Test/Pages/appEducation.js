...
describe('app education happy', function(){
	...
	it('Test pop up', function(){
		...
		cy.get('input[class="textme-input ng-pristine ng-valid ng-star-inserted ng-touched wrongNumber').focus().type('1234567890');
		cy.wait(500);
		cy.get('button[class="textme-button').click();

		//<p _ngcontent-webwise-c35="" class="success"> Success! A text with our link is headed your way. </p>
		cy.get('p[class="success"]').should('contain', 'Success! A text with our link is headed your way.');
		cy.wait(500);
